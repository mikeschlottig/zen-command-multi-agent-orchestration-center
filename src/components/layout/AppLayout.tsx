  ...
  return (
    <SidebarProvider defaultOpen={!isMobile}>
      <div className="relative h-dvh w-full bg-background text-foreground">
        ...
        <div className="absolute inset-0 -z-10 h-full w-full bg-background dark:bg-zinc-950 bg-[linear-gradient(to_right,#8080800a_1px,transparent_1px),linear-gradient(to_bottom,#8080800a_1px,transparent_1px)] bg-[size:14px_24px]">
